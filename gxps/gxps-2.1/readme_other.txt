...
2) Compilation
	...
	1. Install XMGrace (available at http://plasma-gate.weizmann.ac.il/Grace/ or from the distribution repositories). 
	Since xps relies on XMGrace for plotting and fitting, some features may not be available for some platforms, if a
	binaries of XMGrace are not available in such platforms. 
